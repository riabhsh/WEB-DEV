...
// PRACTICE
// {
//   function userInput(name, callbackFunction){
//     console.log(`Recieved Input:`, name);
//     callbackFunction(name);
//   }

//   function greet(naam){
//     console.log("\ncallback functions runs!")
//     console.log(`namaste `, naam);
//   }

//   userInput("Rishabh", greet);
// }
...
// CHALLANGE
{
  ...
  function mathOperation(n1,n2,callbackFun){
    callbackFun(n1,n2);
  }

  let n1 = 10; 
  let n2 =20;
  mathOperation(n1,n2,add);
  mathOperation(n1,n2,sub);
}