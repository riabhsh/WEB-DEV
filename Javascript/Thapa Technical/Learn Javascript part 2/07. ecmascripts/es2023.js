...
// PRACTICE
{
 let arr = [15,151,4,841,58,45,15,4,51]; 
 let nameArr = ["mango", "kiwi", "apple", "chiku"];
// Array.findLast()
// console.log(arr.findLast((x) => x <= 51));

// Array.findLastIndex();
// console.log(arr.findLastIndex((x) => x <= 60));

// Array.prototype.toReversed()
// console.log(arr.toReversed());

// Array.prototype.toSorted(compareFn)
// console.log(nameArr.toSorted())


// Array.prototype.toSpliced(start, deleteCount, ...items)
// console.log(nameArr);
// console.log(nameArr.toSpliced("mango", 2));

// Array.prototype.with(index, value);
// console.log(nameArr);
// console.log(nameArr.with("mango", "aam"));
}
