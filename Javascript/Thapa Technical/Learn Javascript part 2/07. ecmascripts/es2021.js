...

{
  ...
  // const originalString = "namaste sasriyakal aadab kemcho!";
  // const newString = originalString.replaceAll("kemcho", "adonei vasu");
  // console.log(originalString);
  // console.log(newString);

  // const originalString2 = "namaste     sasriyakal aadab    kemcho!";
    // const noSpace = originalString2.replaceAll(/\s+/g, " ");
